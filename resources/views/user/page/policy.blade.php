...
@section('title', 'Docku | Политика конфиденциальности')
  ...
  <div class="container item-page">
    <div class="row">
      ...
      <div class="col-12">
        ...
        <p>9.4. Действующая Политика конфиденциальности размещена на странице по адресу <a href="{{ route('index') }}">{{ route('index') }}</a> адрес магазина.</p>
      </div>
      <div class="col-12 pt-5">
