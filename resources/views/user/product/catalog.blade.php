...
@section('content')
  <div class="container-fluid mt-2 catalog" id="filtered">
    <div class="row justify-content-end">
      <div class="col-auto dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-shadow rounded-0 border-0 py-3 px-4" aria-labelledby="dropdownOrderLink">
          <a href="#" role="button" onclick="orderSort('sort-old')" class="dropdown-item bg-transparent active"><i class="fas fa-sort-amount-down"></i> С начало старые</a>
          <a href="#" role="button" onclick="orderSort('sort-new')" class="dropdown-item bg-transparent "><i class="fas fa-sort-amount-up"></i> С начало новые</a>
          <a href="#" role="button" onclick="orderSort('sort-expensive')" class="dropdown-item bg-transparent "><i class="fas fa-sort-amount-up"></i> С начало дорогие</a>
          <a href="#" role="button" onclick="orderSort('sort-cheap')" class="dropdown-item bg-transparent "><i class="fas fa-sort-amount-down"></i> С начало дешёвые</a>
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <form action="" method="get" id="product-all">
        ...
        <div class="col-auto dropdown h-100">
          ...
          <div class="dropdown-menu dropdown-shadow rounded-0 border-0 py-3 px-4" aria-labelledby="dropdownSizeLink">
            @foreach(\App\Models\Skus::all() as $skus)
              <div class="checkbox">
                <input type="checkbox" class="form-check-input" id="skus-{{$skus->id}}" name="skus[]" value="{{ $skus->id }}">
{{--                {{ in_array($skus->id, $filter['size']) ? 'checked' : null }}--}}
