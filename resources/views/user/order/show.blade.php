            ...
            <transition name="slide-fade" mode="out-in" appear>
              <div class="col-md-9 p-4" v-if="!windowsLoader" key="1">
                ...
                <div class="row mt-4">
                  ...
                  <div class="col-12">
                    <button class="btn btn-dark" @click="pay">Оплатить</button>
                  </div>
                  <div class="col-12 pt-3">
                    <div class="row">
                      @foreach($order->items as $item)
                        <div class="col-md-4">
                          @include('user.layouts.item', ['item' => $item->product])
                        </div>
                      @endforeach
                    </div>
                  </div>
              ...
              <div class="col-md-9 p-4" v-else key="2">
                <div class="row">
                  <div class="col-12 text-center">
                    <h3><strong>Не закрывайте браузер.</strong> Ожидаем подтверждения оплаты. Иначе он будет отменён</h3>
                  </div>
                </div>
              </div>
            </transition>
